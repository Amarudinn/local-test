...
-- ============================================================================
-- Combined from: 00_COMPLETE_FRESH_SETUP.sql + missing columns
...
CREATE INDEX IF NOT EXISTS idx_participants_participant_address ON participants(participant_address);
...
CREATE INDEX IF NOT EXISTS idx_arguments_author_address ON arguments(author_address);
...
CREATE INDEX IF NOT EXISTS idx_sync_queue_status_next_retry ON sync_queue(status, next_retry_at) WHERE status = 'pending';
CREATE INDEX IF NOT EXISTS idx_sync_queue_contract_address ON sync_queue(contract_address);
...
-- ============================================================================
-- 10. RLS POLICIES (Public Access - App uses Privy for auth)
-- ============================================================================
...
WHERE table_schema = 'public' 
  ...
  AND table_name IN ('debates', 'participants', 'arguments', 'leaderboard_results', 'sync_queue', 'evaluation_queue', 'evaluations')
ORDER BY table_name;
